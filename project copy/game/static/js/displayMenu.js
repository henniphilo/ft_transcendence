...
class MenuDisplay {
    constructor() {
        ...
        this.gameMode = null;
        this.playMode = null;
        this.currentSettings = null;  // Store current settings
        this.initWebSocket();
    }
    ...
    async saveSettings() {
        try {
            ...
            console.log('Sending settings:', settings);  // Debugging log
    ...
    handleMenuAction(data) {
        switch (data.action) {
            ...
            case 'start_game':
                ...
                break;
            case 'show_settings':
                this.currentSettings = data.settings;  // Store settings
                this.displaySettings(data.settings);
                break;
            case 'settings_updated':
                this.currentSettings = data.settings;  // Update stored settings
                alert('Settings saved successfully!');
                this.handleMenuClick('back');
                break;
            case 'settings_error':
...
//console.log('uBahn Model:', this.models.uBahn);  // Example of accessing model
