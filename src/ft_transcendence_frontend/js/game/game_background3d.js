...
function init() {
    ...
    loader.load(
        ...
        (xhr) => {
            console.log((xhr.loaded / xhr.total * 100) + '% game background loaded');
        },
        (error) => console.error('Error loading game background model:', error)
    );
...
export function initGameBackground3D() {
    init();
}
